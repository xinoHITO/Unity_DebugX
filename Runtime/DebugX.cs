...
public static class DebugX
{
    ...
    public static void Log(object obj, Color color)
    {
        ...
        UnityEngine.Debug.Log(string.Format("<color=#{0}>{1}</color>", colorHex, obj));
    }
    ...
    public static void Log(object obj, Object context, Color color)
    {
        if (!IsEnable()) return;
        string colorHex = ColorUtility.ToHtmlStringRGB(color);
        UnityEngine.Debug.Log(string.Format("<color=#{0}>{1}</color>", colorHex, obj), context);
    }
    ...
    public static void LogWarning(object obj, Color color)
    {
        if (!IsEnable()) return;
        string colorHex = ColorUtility.ToHtmlStringRGB(color);
        UnityEngine.Debug.LogWarning(string.Format("<color=#{0}>{1}</color>", colorHex, obj));
    }
    ...
    public static void LogWarning(object obj, Object context, Color color)
    {
        if (!IsEnable()) return;
        string colorHex = ColorUtility.ToHtmlStringRGB(color);
        UnityEngine.Debug.LogWarning(string.Format("<color=#{0}>{1}</color>", colorHex, obj), context);
    }
    ...
    public static void LogError(object obj, Color color)
    {
        if (!IsEnable()) return;
        string colorHex = ColorUtility.ToHtmlStringRGB(color);
        UnityEngine.Debug.LogError(string.Format("<color=#{0}>{1}</color>", colorHex, obj));
    }
    ...
    public static void LogError(object obj, Object context, Color color)
    {
        if (!IsEnable()) return;
        string colorHex = ColorUtility.ToHtmlStringRGB(color);
        UnityEngine.Debug.LogError(string.Format("<color=#{0}>{1}</color>", colorHex, obj), context);
    }
